...
namespace AppCoel.Core.API.Middlewares
{
    public class ExceptionMiddlewares
    {
        ...
        private async Task HandleExceptionAsync(HttpContext context, ExceptionCode exceptionCode = ExceptionCode.Generic,
                                        string? additionalInfo = null, HttpStatusCode httpStatusCode = HttpStatusCode.InternalServerError)
        {
